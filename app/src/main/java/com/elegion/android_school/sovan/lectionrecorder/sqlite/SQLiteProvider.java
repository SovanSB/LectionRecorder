package com.elegion.android_school.sovan.lectionrecorder.sqlite;
    ...
    private static final class SQLiteHelperImpl extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL("CREATE TABLE IF NOT EXISTS tasks(_id INTEGER PRIMARY KEY, title TEXT, " +
                    "id INTEGER, file_name TEXT, path TEXT, start_time LONG, running_time LONG, " +
                    "period LONG, is_periodical BOOLEAN, is_numeric BOOLEAN, audio_source INTEGER, " +
                    "audio_encoder INTEGER, output_format INTEGER);");
        }
